...
//Liste des auteurs
$listeauteur[] = new Auteur (["titre"=>"Les Misérables","nom"=>"Hugo","prenom"=>"Victor","dateNaissance"=>new DateTime("1800-01-25"),"dateDeces"=>new DateTime("1855/01/26"),"emprunt"=>"Oui"]);
$listeauteur[] = new Auteur (["titre"=>"Le grand secret","nom"=>"Barjavel","prenom"=>"René","dateNaissance"=>new DateTime("1800-01-25"),"dateDeces"=>"","emprunt"=>"Non"]);
$listeauteur[] = new Auteur (["titre"=>"1984","nom"=>"Owell","prenom"=>"Georges","dateNaissance"=>new DateTime("1800-01-25"),"dateDeces"=>new DateTime("1855/01/26"),"emprunt"=>"Oui"]);
